...
function createWebhookApi(http) {
  ...
  return {
    update: function update() {
      ...
      return endpoints.webhook.update(http, getParams(data), data).then(function (data) {
    ...
    getCall: function getCall(id) {
      var data = this.toPlainObject();
      return endpoints.webhook.getCallDetails(http, _objectSpread(_objectSpread({}, getParams(data)), {}, {
        callId: id
      }));
    },
