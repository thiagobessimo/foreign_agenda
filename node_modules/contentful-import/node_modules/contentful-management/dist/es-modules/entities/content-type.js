...
import { isUpdated as _isUpdated, isPublished as _isPublished, isDraft as _isDraft } from '../plain/checks';
...
function createContentTypeApi(http) {
  ...
  return {
    update: function update() {
      ...
      return endpoints.contentType.update(http, params, raw).then(function (data) {
    ...
    "delete": function _delete() {
      ...
      return endpoints.contentType.del(http, params).then(function () {// noop
      });
    },
    publish: function publish() {
      ...
      return endpoints.contentType.publish(http, params, raw).then(function (data) {
        return wrapContentType(http, data);
      });
    },
    unpublish: function unpublish() {
      ...
      return endpoints.contentType.unpublish(http, params).then(function (data) {
        return wrapContentType(http, data);
      });
    },
    getEditorInterface: function getEditorInterface() {
      ...
      return endpoints.editorInterface.get(http, params).then(function (data) {
        return wrapEditorInterface(http, data);
      });
    },
    getSnapshots: function getSnapshots() {
      ...
      return endpoints.snapshot.getManyForContentType(http, _objectSpread(_objectSpread({}, params), {}, {
        query: query
      })).then(function (data) {
    ...
    getSnapshot: function getSnapshot(snapshotId) {
      ...
      return endpoints.snapshot.getForContentType(http, _objectSpread(_objectSpread({}, params), {}, {
        snapshotId: snapshotId
      })).then(function (data) {
        return wrapSnapshot(http, data);
      });
    },
    ...
    omitAndDeleteField: function omitAndDeleteField(id) {
      ...
      return endpoints.contentType.omitAndDeleteField(http, params, raw, id).then(function (data) {
        return wrapContentType(http, data);
      });
    }
  };
