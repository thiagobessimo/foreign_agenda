...
function createCMAHttpClient(params) {
  ...
  "".concat(sdkMain, "/").concat("7.4.0"), params.application, params.integration, params.feature);
  var requiredHeaders = {
...
function errorHandler(errorResponse) {
  ...
  try {
    ...
    error.message = lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(errorData, ['message'], '');
  }
