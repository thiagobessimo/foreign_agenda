...
function createCMAHttpClient(params) {
  ...
  `contentful-management.js/${"6.3.2"}`, params.application, params.integration, params.feature);
...
function createSpaceApi({
  ...
  return {
    ...
    getRoles(query = {}) {
      normalizeSelect(query);
      return http.get('roles', Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
        query
      })).then(response => wrapRoleCollection(http, response.data), _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
